...
MBN_modes_map(37,36)=45; % Set center 'known' value
MBN_modes_map(36,36)=44; % Set center 'known' value
MBN_modes_map(36,35)=43; % Set center 'known' value
        ...
        for ii=1:2
            ...
            if MBN_modes_map(iL,iR)==0
                ...
                if ~isnan(nu_pot) % If there are good values to assign
                    ...
                    temp_trace_v=permute(Tr_v(iL,iR,mode_pot),[3 1 2]);
...
colormap('jet');colorbar;xlabel('\DeltaR');ylabel('\DeltaL');
% figure;contourf(axis_vec-81,axis_vec(1:end)-81,freq_map(1:end,:),50,'edgecolor','none');
% colormap('jet');colorbar;xlabel('\DeltaR');ylabel('\DeltaL');
end
